...
ALTER TABLE [AdvellaDW].[stage].[Fact_Service_Reporting] ADD CONSTRAINT FK_Service_Id_Service_Reporting FOREIGN KEY(service_id) REFERENCES [AdvellaDW].[stage].[Dim_Services](service_id);
...
ALTER TABLE [AdvellaDW].[stage].[Fact_Product_Reporting] ADD CONSTRAINT FK_Product_Id_Product_Reporting FOREIGN KEY(product_id) REFERENCES [AdvellaDW].[stage].[Dim_Products](product_id);
...
alter table [AdvellaDW].[stage].[Fact_Service_Reporting] drop constraint FK_Service_Id_Service_Reporting;
...
alter table [AdvellaDW].[stage].[Fact_Product_Reporting] drop constraint FK_Product_Id_Product_Reporting;
